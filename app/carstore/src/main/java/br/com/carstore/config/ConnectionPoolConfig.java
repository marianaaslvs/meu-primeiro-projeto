...
public class ConnectionPoolConfig {
    ...
    /*Com a implementação do connection pool, nenhum método da DAO irá mais criar conexões, ao invés disso,
    ele irá pedir uma conexão para o nosso pool que por sua vez irá fazer o reaproveitamento de conexões existesntes
    que estiverem disponíveis e caso não existe, irá criar uma nova conexão.*/
